export default function AppLogo({ className = 'h-28 w-28 fill-[rgb(75,195,117)]' }: { className?: string }) {
  return (
    <svg id="app-logo" transform="matrix(0.10739424268424479,0,0,0.10739424268424479,0,0)" className={className} viewBox="0 0 600 600">
